...
namespace App\Livewire\Admin\RgpdContacts;
...
class Index extends Component
{
    ...
    {
        $this->authorize('rgpd-contacts.create');
        $this->resetForm();
        $this->showForm = true;
    }
    ...
    {
        $this->authorize('rgpd-contacts.update');
    ...
    {
        $this->authorize('rgpd-contacts.delete');
    ...
    public function render()
    {
        ...
        return view('livewire.admin.rgpd-contacts.index', [
